<template>
  <Head>
    <title>Edit Referensi - Sistem Informasi Stok Gudang</title>
  </Head>
  <main class="c-main">
              ...
              <div class="card-body">
                <form @submit.prevent="submit">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="jenis referensi" class="font-weight-bold"
...
export default {
  ...
  setup(props) {
    const form = reactive({
      nama: props.referensi.nama,
      deskripsi: props.referensi.deskripsi,
      jenis_referensi: props.referensi.jenis_referensi,
    });
    const submit = () => {
      Inertia.put(
        `/apps/references/${props.referensi.id}`,
        {
          nama: form.nama,
          deskripsi: form.deskripsi,
          jenis_referensi: form.jenis_referensi,
          id: props.referensi.id,
        },
        {
          onSuccess: () => {
            Swal.fire({
