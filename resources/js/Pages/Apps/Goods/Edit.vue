<template>
  <Head>
    <title>Edit Barang - Sistem Informasi Stok Gudang</title>
  </Head>
  <main class="c-main">
                      ...
                      <div class="mb-3">
                        ...
                        <select class="form-select" v-model="form.kategori">
                          ...
                          <option
                            ...
                            :key="index"
                            :value="data.id"
                            :selected="data.id == form.kategori"
                          >
                            {{ data.nama }}
                          </option>
                        </select>
...
export default {
  ...
  setup(props) {
    const form = reactive({
      ...
      satuan: props.barang.referensi_satuan,
      kategori: props.barang.referensi_kategori,
      stok: props.barang.stok,
    });
    const submit = () => {
      Inertia.put(
        `/apps/goods/${props.barang.id}`,
        {
          nama: form.nama,
          satuan: form.satuan,
