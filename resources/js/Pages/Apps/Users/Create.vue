                    ...
                    <div class="col-md-12">
                        <div class="card border-0 rounded-3 shadow border-top-purple">
                            <div class="card-header">
                                <span class="font-weight-bold"><i class="fas fa-users"></i> Tambah User</span>
                            </div>
                            <div class="card-body">
                                <form @submit.prevent="submit">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-check-inline" v-for="(role,index) in roles"
                                                     :key="index">
                                                    <input type="checkbox" class="form-check-input" v-model="form.roles"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <button class="btn btn-primary shadow-sm rounded-sm" type="submit">SAVE
                                            </button>
